...
<head>
  ...
  <title>Bijwerken van producten - Bakkerij Leiden</title>
...
<!-- Container. -->
<div class="content">
  <h2>Bijwerken van producten</h2>
  <!-- The product list in admin panel. -->
  <div class="list">
    <form action="quantity-update.php" method="post">
      <table>
        <thead>
          <tr>
            <th>#</th>
        ...
        <tbody>
          <tr>
            ...
            <td><input type="number" name="product<?=$row['id']?>" placeholder="<?=$row['quantity']?>"></td>
          </tr>
        </tbody>
        <?php 
          } 
